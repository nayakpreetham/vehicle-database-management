        ...
        phoneLayout.setHorizontalGroup(
            ...
            .addGroup(phoneLayout.createSequentialGroup()
                ...
                .addGroup(phoneLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    ...
                    .addComponent(PHONE)
                    .addComponent(email)
                    .addComponent(calender, javax.swing.GroupLayout.PREFERRED_SIZE, 161, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGroup(phoneLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(phoneLayout.createSequentialGroup()
                        .addGap(82, 82, 82)
                        .addGroup(phoneLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                ...
                .addGroup(phoneLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(phoneLayout.createSequentialGroup()
                        ...
                        .addGroup(phoneLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addGroup(phoneLayout.createSequentialGroup()
                                .addComponent(calender, javax.swing.GroupLayout.PREFERRED_SIZE, 38, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addContainerGap())))))
        );
    ...
    private void updateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateActionPerformed
        ...
        TableModel model = customertable.getModel();
          String str=model.getValueAt(i,1).toString();
            ...
            String query = "UPDATE customer SET custname=?,phone=?,email=?,dob=?,address=?,vehid=? WHERE custid =?;";
          ...
          ps=connect.getConnection().prepareStatement(query);
                 ...
                 sqldate=new java.sql.Date(calender.getDate().getTime());
                 
                          ps.setString(2,PHONE.getText());
                                   ps.setString(3,email.getText());
                                  ps.setDate(4,sqldate);
                                   ps.setString(5,address.getText());
                                   ps.setString(6,carid.getText());
