 ...
 * @author user
 */
public class usersoldvehicles extends javax.swing.JFrame {

    /**
     * Creates new form soldvehicles
     */
    public usersoldvehicles() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jPanel1.add(panel, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 90, 1080, 400));
        ...
        getContentPane().add(back, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 510, 160, 30));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(usersoldvehicles.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new usersoldvehicles().setVisible(true);
            }
        });
    }
